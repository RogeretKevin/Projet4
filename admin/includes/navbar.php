...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <!-- Nav Item - chapitre -->
  <li class="nav-item">
    <a class="nav-link" href="adminIndex.php?p=posts">
      <i class="fas fa-book-open"></i>
      <span>Voir tous les chapitres</span></a>
  </li>

  <li class="nav-item">
    <a class="nav-link" href="adminIndex.php?p=newcreate">
      <i class="fas fa-feather"></i>
      <span>Ajouter un chapitre</span></a>
  </li>
  ...
  <!-- Nav Item - chapitre -->
  <li class="nav-item">
    <a class="nav-link" href="adminIndex.php?p=comments">
      <i class="fas fa-comments"></i>
      <span>Commentaires</span></a>
  </li>

  <li class="nav-item">
    <a class="nav-link" href="adminIndex.php?p=form">
